...
const LengkapiDataSiswaBaruYpbm: React.FC<Props> = ({ token, dataAll }) => {
  ...
  // State for the additional fields when "Ya" is selected
  ...
  const lastEducationOptions = [
    { value: 'not_school', label: 'Belum Sekolah' },
    { value: 'tk', label: 'TK' },
    { value: 'sd', label: 'SD' },
    { value: 'smp', label: 'SMP' },
    { value: 'sma', label: 'SMA' }
  ...
  const JobOptions = [
    ...
    { value: 'pns_tni_polri', label: 'PNS/TNI/POLRI' },
    { value: 'karyawan_swasta', label: 'Karyawan Swasta' },
    { value: 'pedangang_kecil', label: 'Pedangang Kecil' },
    { value: 'pedangang_besar', label: 'Pedangang Besar' },
    { value: 'wiraswasta', label: 'Wiraswasta' },
  ...
  const IncomeOptions = [
    ...
    { value: 'Rp. 2.000.000 - Rp. 3.499.999', label: 'Rp. 2.000.000 - Rp. 3.499.999' },
    { value: 'Rp. 3.500.000 - Rp. 4.999.999', label: 'Rp. 3.500.000 - Rp. 4.999.999' },
      ...
      <form onSubmit={handleFormSubmit}>
        <CardContent>
          <Grid spacing={1}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={6}>
                    <CustomTextField
                      ...
                      inputProps={{
                        maxLength: 4, // Batas panjang maksimal 4 karakter
                        inputMode: 'numeric', // Pastikan keyboard numerik pada perangkat mobile
                        pattern: '[0-9]*' // Tentukan pola angka untuk beberapa browser
                      }}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={6}>
                    <CustomTextField
                      ...
                      onChange={(e: React.ChangeEvent<{ value: unknown }>) => {
                        setFatherIncome(e.target.value as string)
                      }}
                    >
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={6}>
                    <CustomTextField
                      ...
                      value={motherIncome}
                      onChange={(e: React.ChangeEvent<{ value: unknown }>) => {
                        setMotherIncome(e.target.value as string)
                      }}
                    >
                      {IncomeOptions.map(option => (
                        <MenuItem key={option.value} value={option.value}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={6}>
                    <CustomTextField
                      ...
                      onChange={(e: React.ChangeEvent<{ value: unknown }>) => {
                        setGuardianIncome(e.target.value as string)
                      }}
                    >
                      {IncomeOptions.map(option => (
                        <MenuItem key={option.value} value={option.value}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={3}>
                    <CustomTextField
                      ...
                      label={
                        <>
                          <span>Upload Akte Lahir/ Ktp</span>
                          <span style={{ color: 'red' }}> (Max 500kb)</span>
                        </>
                      }
                      name='akteLahir'
                  ...
                  <Grid item xs={12} sm={6} md={4} lg={3}>
                    <CustomTextField
                      ...
                      label={
                        <>
                          <span>Upload Pas Foto siswa</span>
                          <span style={{ color: 'red' }}> (Max 500kb)</span>
                        </>
                      }
                      name='ktpOrangtua'
            ...
            <Accordion>
              <AccordionSummary expandIcon={<GridExpandMoreIcon />} aria-controls='panel8a-content' id='panel8a-header'>
                <Typography variant='body1' sx={{ fontWeight: 600 }}>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6} md={4} lg={6}>
                    <CustomTextField
                      ...
                      name='registrantType' // Changed the name attribute here
                      placeholder='Pilih'
                      select
                      required
                    ...
                    <>
                      ...
                      <Grid item xs={12} sm={6} md={4}>
                        <CustomTextField
                          ...
                          name='graduationYearFromLastSchool'
...
export default LengkapiDataSiswaBaruYpbm
